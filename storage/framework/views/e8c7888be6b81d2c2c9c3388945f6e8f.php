...
<?php $__env->startSection('title', 'Struk ' . $transaksi->kode); ?>
...
<div class="receipt-wrapper mb-4">
    <div class="print-actions">
        <a href="<?php echo e(route('transaksi.struk_pdf', $transaksi)); ?>" class="btn btn-sm btn-ff-outline">
            Download PDF
        </a>
    ...
    <div class="receipt-card">
        ...
        <div class="receipt-header">
            ...
            <div class="text-end">
                ...
                <div style="font-size: 0.85rem; color:#6b7280;">
                    Kode: <strong><?php echo e($transaksi->kode); ?></strong><br>
                    Tanggal: <?php echo e($transaksi->created_at->format('d M Y H:i')); ?>
        ...
        <div class="info-grid">
            <div>
                ...
                <div class="info-value"><?php echo e($transaksi->nama_pelanggan); ?></div>
            </div>
            <div>
                <div class="info-label">No. HP</div>
                <div class="info-value">
                    <?php echo e($transaksi->no_hp ?: '-'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\fourzfish\resources\views/transaksi/struk.blade.php ENDPATH**/ ?>